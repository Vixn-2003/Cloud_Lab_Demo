...
- [x] **Hỗ trợ Giao diện Sáng (Light Mode)**
  ...
  - [x] Chuyển đổi tính năng Tạo/Sửa ca thực hành từ dạng hộp thoại nổi (Popup modal) sang dạng trang nội bộ chiều sâu (Drill-down full-page layout) giúp tối đa hóa không gian hiển thị thông tin phức tạp, tích hợp điều hướng breadcrumbs quay lại tiện lợi.
